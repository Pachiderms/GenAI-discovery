...
from backend.src.file_handler import FileHandler
from backend.src.rag_logic import RAGLogic
import json
...
file_handler.init_db()  # Initialisation de la base de données au démarrage de l'application
